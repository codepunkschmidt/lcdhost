    ...
    case LUA_TSTRING:
        {
            ...
            LH_Variant::fromString( QString::fromUtf8(str, len) );
        }
        break;
    case LUA_TTABLE:
    {
...
void LH_LuaVariant::push( lua_State *L )
{
    ...
    {
        lua_pushinteger(L,LH_Variant::toLongLong());
        return;
    }
    if( type() == QVariant::Double )
    {
        lua_pushnumber(L,LH_Variant::toDouble());
        return;
    }
    ...
    const QByteArray ba( LH_Variant::toString().toUtf8() );
