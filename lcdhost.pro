...
defineTest(lcdhost_prf) {
	win32: system(echo $$quote($$1)>>$$PWD/$$LCDHOST_PRF)
	else: system(echo \'$$quote($$1)\'>>$$PWD/$$LCDHOST_PRF)
}

isEmpty(LCDHOST_PRF): LCDHOST_PRF="lcdhost.prf"
for( i, 1..10 ): !exists($$PWD/$$LCDHOST_PRF): LCDHOST_PRF=../$$LCDHOST_PRF

!exists($$PWD/$$LCDHOST_PRF) {
	LCDHOST_PRF="lcdhost.prf"
	warning("creating default $$PWD/$$LCDHOST_PRF")
