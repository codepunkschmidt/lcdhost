...
class LH_Qt_array_double_ui : public LH_Qt_array_double
{
    ...
    void init(lh_meta_type ui_type, int uiFlags, bool _fixedRange = false, double min = 0, double max = 0 );

public:
    LH_Qt_array_double_ui( LH_QtObject *parent, const char *ident, int size = 0, int flags = 0, lh_meta_type ui_type = lh_type_double)
    ...
    LH_Qt_array_double_ui( LH_QtObject *parent, const char *ident, int size = 0, double min = 0, double max = 0, int flags = 0, lh_meta_type ui_type = lh_type_double )
        : LH_Qt_array_double( parent, ident, size, flags | LH_FLAG_HIDDEN )
    {
